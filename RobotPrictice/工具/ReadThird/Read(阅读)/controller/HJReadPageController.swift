...
class HJReadPageController: HJViewController,UIPageViewControllerDelegate,UIPageViewControllerDataSource,DZMCoverControllerDelegate,UIApplicationDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 设置回调代理
//        (UIApplication.shared.delegate as! UIApplication).delegate = self
    }
