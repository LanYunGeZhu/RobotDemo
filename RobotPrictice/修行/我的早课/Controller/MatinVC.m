...
#import "MatinVC.h"
#import "MatinBottomView.h"

@interface MatinVC ()<UITableViewDelegate,UITableViewDataSource>
{
    SFPlayTool *playTool;
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    MatinBottomView *view = [[MatinBottomView alloc]init];
...
- (void)addMatinButton:(UIButton *)btn{
    NSLog(@"\n\n选中第%ld行   添加到早课",btn.tag);
}
- (void)removeMatinButton:(UIButton *)btn{
    NSLog(@"\n\n选中第%ld行   从早课移除",btn.tag);
}
